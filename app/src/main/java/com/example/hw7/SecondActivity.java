...
public class SecondActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinnerForRegions = (Spinner) findViewById(R.id.district_spinner);
        ...
        spinnerForRegions.setAdapter(adapterSp);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {//V in menu
        switch (item.getItemId()) {
            case R.id.action_apply:
                ...
                intent.putExtra("district", spinnerForRegions.getSelectedItem().toString());
